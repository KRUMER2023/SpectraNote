...
class ImageLoader:
    ...
    def __init__(self):
        ...
        self.image_new_note =  PhotoImage(file=self.asset("button_5.png"))
        self.image_summary =  PhotoImage(file=self.asset("button_4.png"))
        self.image_web_search =  PhotoImage(file=self.asset("button_3.png"))
        ...
        self.images ={
            ...
            "new_note":         self.image_new_note,
            "summary":          self.image_summary,
            "web_search":       self.image_web_search,
